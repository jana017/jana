...
const SOURCE_META = {
  talos:        { label: "Vendor Threat Advisories",           tag: "Vendors",      tone: "text-red-400",       gradient: "from-red-500/10 to-transparent",       chip: "bg-red-50 text-red-700" },
  unit42:       { label: "Adversary Deep-Dives",               tag: "Research",     tone: "text-blue-400",      gradient: "from-blue-500/10 to-transparent",      chip: "bg-blue-50 text-blue-700" },
  dfir:         { label: "Incident Response Reports",          tag: "IR",           tone: "text-amber-400",     gradient: "from-amber-500/10 to-transparent",     chip: "bg-amber-50 text-amber-700" },
  msthreat:     { label: "Nation-State Threat Intelligence",   tag: "APT",          tone: "text-emerald-400",   gradient: "from-emerald-500/10 to-transparent",   chip: "bg-emerald-50 text-emerald-700" },
  bleeping:     { label: "Breaking Security News",             tag: "News",         tone: "text-orange-400",    gradient: "from-orange-500/10 to-transparent",    chip: "bg-orange-50 text-orange-700" },
  hn:           { label: "Community Signals",                  tag: "Signals",      tone: "text-[#F5821F]",     gradient: "from-orange-500/10 to-transparent",    chip: "bg-orange-50 text-orange-700" },
  thn:          { label: "Cybersecurity Headlines",            tag: "Headlines",    tone: "text-purple-400",    gradient: "from-purple-500/10 to-transparent",    chip: "bg-purple-50 text-purple-700" },
  krebs:        { label: "Investigative Security Journalism",  tag: "Investigative",tone: "text-rose-400",      gradient: "from-rose-500/10 to-transparent",      chip: "bg-rose-50 text-rose-700" },
  darkreading:  { label: "Enterprise Security Analysis",       tag: "Enterprise",   tone: "text-slate-500",     gradient: "from-slate-500/10 to-transparent",     chip: "bg-slate-100 text-slate-700" },
  securityweek: { label: "Weekly Security Briefings",          tag: "Weekly",       tone: "text-indigo-400",    gradient: "from-indigo-500/10 to-transparent",    chip: "bg-indigo-50 text-indigo-700" },
  therecord:    { label: "Intelligence Community Reports",     tag: "Intel Comm.",  tone: "text-fuchsia-400",   gradient: "from-fuchsia-500/10 to-transparent",   chip: "bg-fuchsia-50 text-fuchsia-700" },
};
