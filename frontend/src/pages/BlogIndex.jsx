...
import { Calendar, ArrowUpRight, Tag, Clock, BookOpen } from "lucide-react";
...
export default function BlogIndex() {
  useSeo({
    title: "NivX Blogs · Threats, Attacks & SOC Playbooks | NivX Machines",
    ...
    canonical: "https://nivxmachines.com/blog",
  });
      ...
      <section className="pt-28 pb-14 lg:pt-32 bg-[#0A1220] relative overflow-hidden border-b border-slate-800">
        ...
        <div className="relative mx-auto max-w-7xl px-6">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 text-orange-300 rounded-full px-3 py-1 text-xs font-semibold mb-5">
            <BookOpen className="w-4 h-4" /> NivX Blogs
          </div>
          ...
          <p className="mt-3 text-sm text-slate-500">
            <span className="font-semibold text-slate-300">{BLOG_POSTS.length}</span> articles · updated regularly by the NivX editorial team.
          </p>
        </div>
      </section>
