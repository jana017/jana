    ...
    >
      <nav className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-7">
          ...
          <a
            href="https://nivxmachines.com/threat-intelligence"
          ...
          <a
            href="https://nivxmachines.com/nivx-forge"
      ...
      {open && (
        <div className="lg:hidden bg-white border-t border-slate-200 px-6 py-5 flex flex-col gap-4" data-testid="mobile-menu">
          ...
          <a href="https://nivxmachines.com/threat-intelligence" onClick={() => setOpen(false)} className="inline-flex items-center gap-2 text-left text-sm font-bold">
          ...
          <a href="https://nivxmachines.com/nivx-forge" data-testid="mobile-nav-cyberlab" onClick={() => setOpen(false)} className="inline-flex items-center gap-2 text-left text-sm font-bold">
