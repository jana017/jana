...
import { Phone, Mail, ShieldHalf } from "lucide-react";
    ...
    <footer id="support" data-testid="support-section" className="relative pt-28 pb-12 border-t border-white/5">
      <div className="mx-auto max-w-[1400px] px-6">
        <div className="grid lg:grid-cols-2 gap-16 mb-24">
          <div>
            <div className="font-mono-data text-[11px] uppercase tracking-[0.3em] text-[#00F0FF] mb-6">/ Support</div>
            <h2 className="font-display font-black tracking-tighter text-white text-4xl sm:text-5xl lg:text-6xl leading-[0.92]">
              Under attack?
              <br />
              <span className="text-[#00F0FF] text-glow">Talk to us.</span>
            </h2>
            <p className="text-[#A1A1A5] mt-6 max-w-md text-lg leading-relaxed">
          ...
          <div className="flex flex-col gap-4 justify-center">
            <motion.a
              ...
              className="group glass flex items-center gap-5 p-6 hover:border-[#00F0FF]/50 transition-colors"
            >
              <div className="w-12 h-12 flex items-center justify-center border border-[#00F0FF]/30 group-hover:bg-[#00F0FF] transition-colors">
                <Phone className="w-5 h-5 text-[#00F0FF] group-hover:text-black transition-colors" />
              </div>
              <div>
            ...
            >
              <div className="w-12 h-12 flex items-center justify-center border border-[#00F0FF]/30 group-hover:bg-[#00F0FF] transition-colors">
                <Mail className="w-5 h-5 text-[#00F0FF] group-hover:text-black transition-colors" />
              </div>
              <div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-white/10">
          ...
          <p className="font-mono-data text-[11px] uppercase tracking-widest text-[#66666E]">
